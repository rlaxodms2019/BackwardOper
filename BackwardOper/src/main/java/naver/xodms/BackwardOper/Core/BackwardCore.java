package naver.xodms.BackwardOper.Core;
...
import naver.xodms.BackwardOper.Operator.ABS_Calculer;
import naver.xodms.BackwardOper.Operator.NumOperand;
import naver.xodms.BackwardOper.Stack.Stack;
...
{// 5월 2일 연산 과정 표시 수정.
Stack<ABS_CalMember> tempStack = new Stack<ABS_CalMember>(calStack.getSlotSize());// 연산을 위한 
//임시 스택.
